...
<head>
  ...
  @vite(['resources/css/admin.css', 'resources/css/bootstrap.min.css', 'resources/css/font-awesome.min.css', 'resources/css/dataTables.bootstrap4.css'])
			...
			<div class="list_general">
				<ul>
                    ...
                    <li>
						...
						<h4>{{$appointment->doctor->getFullName()}}<i class="pending">{{$appointment->appointment_status}}</i></h4>
						<ul class="booking_details">
							<li><strong>Booking date</strong>{{explode(" ",$appointment->appointment_time)[0]}}</li>
							<li><strong>Booking time</strong> {{explode(" ",$appointment->appointment_time)[1]}}</li>
							<li><strong>Visits</strong>{{implode(",",json_decode($appointment->appointment_subject))}}</li>
							<li><strong>Type</strong>{{$appointment->appointment_type}}</li>
							<li><strong>Meeting Link</strong><a target="_blank" href="{{$appointment->appointment_link}}">Zoom Link</a></li>
						</ul>
						<ul class="buttons">
